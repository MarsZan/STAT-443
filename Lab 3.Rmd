...
As $alpha \rightarrow -1$, the decay of autocorrelation coefficient becomes more and more slowly. As we can see that when $alpha \rightarrow -1$, the time serie becomes less and less stationary. 
