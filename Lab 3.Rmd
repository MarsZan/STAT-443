...
When $\alpha \rightarrow 1$, we observe that the decay of autocorrelation coefficients become more and more slowly. The time series data exhibit a stronger and stronger positive temporal correlation in the data. The time series become more non-stationary. 
