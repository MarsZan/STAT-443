...
I decided to fit a $ARMA(3,0,0)$ model. Looking at the plot for the simulated time series, it appears this series is stationary, so I did not include a non-zero mean. 
